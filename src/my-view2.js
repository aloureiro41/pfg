...
class MyView2 extends PolymerElement {
  ...
  for (var i=0; i< contenidoJardines.length;i++){
    var marcadores= L.marker([raizJardines.childNodes[i].childNodes[1].innerHTML, raizJardines.childNodes[i].childNodes[2].innerHTML],{ title: raizJardines.childNodes[i].childNodes[0].innerHTML }, {draggable: true}).addTo(mymap);
    var nuevaPosicion=new L.LatLng(raizJardines.childNodes[i].childNodes[1].innerHTML,raizJardines.childNodes[i].childNodes[2].innerHTML);
