...
class MyView3 extends PolymerElement {
  ...
  for (var i=0; i< contenidoOficinas.length;i++){
    var marcadores= L.marker([raizOficinas.childNodes[i].childNodes[1].innerHTML, raizOficinas.childNodes[i].childNodes[2].innerHTML],{ title: raizOficinas.childNodes[i].childNodes[0].innerHTML }, {draggable: true}).addTo(mymap);
    var nuevaPosicion=new L.LatLng(raizOficinas.childNodes[i].childNodes[1].innerHTML,raizOficinas.childNodes[i].childNodes[2].innerHTML);
